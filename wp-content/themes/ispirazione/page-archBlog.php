...
<?php $permalink = get_permalink(); ?>
        <div class="wrapPost100">
            ...
            <?php echo do_shortcode('[easy-social-share buttons="twitter,facebook" counters=0 template="grey-blocks-retina" text="Blog Música UNAM" url="'.$permalink.'"]') ?>
             <div class="cleargrey"></div>
        </div>
