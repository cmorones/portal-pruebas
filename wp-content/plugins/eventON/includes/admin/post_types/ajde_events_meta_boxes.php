		...
		<div id='evcal_dates' date_format='<?php echo $evcal_date_format[0];?>'>
			...
			<div id='evcal_rep' class='evd'>
				...
				<div class='evcalr_2' style='display:<?php echo $display ?>'>
					...
					<p class='evcalr_2_freq evcalr_2_p'><span class='evo_form_label'><?php _e('Frequency','eventon');?>:</span> <select id='evcal_rep_freq' name='evcal_rep_freq'>
					<?php
					...
					?>						
					<p class='evcalr_2_rep evcalr_2_p'><span class='evo_form_label'><?php _e('Gap between repeats','eventon');?>:</span>
					...
					<?php // monthly only ?>
						...
						<p class='evcalr_2_p evo_rep_month_2'  style='display:<?php echo $__display_none_2;?>'>
							...
							<select id='evo_wom' name='evo_repeat_wom'>
								...
								<option value='1' <?php echo ('1'== $evo_repeat_wom)? 'selected="selected"':null;?>><?php _e('First','eventon');?></option>
								<option value='2' <?php echo ('2'== $evo_repeat_wom)? 'selected="selected"':null;?>><?php _e('Second','eventon');?></option>
								<option value='3' <?php echo ('3'== $evo_repeat_wom)? 'selected="selected"':null;?>><?php _e('Third','eventon');?></option>
								<option value='4' <?php echo ('4'== $evo_repeat_wom)? 'selected="selected"':null;?>><?php _e('Fourth','eventon');?></option>
								<option value='-1' <?php echo ('-1'== $evo_repeat_wom)? 'selected="selected"':null;?>><?php _e('Last','eventon');?></option>
							</select>
						</p>
			...
			<div class='evcal_data_block_style1'>
				...
				<div class='evcal_db_data'>			
					...
					<div class='evo_metafield_image' style='padding-top:10px'>
						...
						<p >
							<input id='evo_loc_img_id' class='evo_loc_img' name="evo_loc_img" type="hidden" class="custom_upload_image" value="<?php echo ($loc_img_id)? $loc_img_id: null;?>" /> 
