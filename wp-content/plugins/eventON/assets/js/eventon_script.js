...
*/
	...
	/*	PRIMARY hook to get content	*/
	 ...
	 //ispirazione previene mostrar listado ev_cal.find('.eventon_events_list').delay(300).slideDown('slow');
         $('.content-area .eventon_events_list').delay(300).slideDown('slow');
